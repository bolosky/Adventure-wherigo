...
int p34() {
	object_type_3_buffer[715] += 1; if (item_location[110] == 484 && object_type_3_buffer[PLAYER_LOCATION] != 412)
	{
		set_object_location(110, 412); modifyObjectFlag('c', 110, 4);
	}
} int a26() {
	l12(0, 686, 0); if (object_type_3_buffer[715] < 1)
	{
		...
		*= object_type_3_buffer[134]; if (cheezy_rand(100) < object_type_3_buffer[702]) {
		object_type_3_buffer[701] = cheezy_rand(object_type_3_buffer[760]); object_type_3_buffer[701] += 1;
		*getObjectPointer(675) = -1; object_type_3_buffer[675] = ITEM_MIN_ID - 1; while (++object_type_3_buffer[675] <= ITEM_MAX_ID) {
			if (isObjectFlagSet(t11(675), 3) &&
				item_location[object_type_3_buffer[675]] == 435) {
	...
	*getObjectPointer(703) = -1; object_type_3_buffer[703] = ITEM_MIN_ID - 1; while (++object_type_3_buffer[703] <= ITEM_MAX_ID)
	{
		if (object_type_3_buffer[686] == 0) { a26(); } if (!(object_type_3_buffer[686] == 0)) {
			set_object_location(object_type_3_buffer[686], object_type_3_buffer[671]); object_type_3_buffer[760]
				-= 1; b26(); if (object_type_3_buffer[699] == 0) { printMessage(2, 686, 0); } l12(0, 686, 0);
		} object_type_3_buffer[134] -=
			1; object_type_3_buffer[715] -= 1; if (object_type_3_buffer[134] == 0) { set_object_location(134, 484); return 0; } object_type_3_buffer[704] -= 1;
		if (object_type_3_buffer[704] == 0) { return 0; }
	}
} int e24() {
	object_type_3_buffer[699] = cheezy_rand(5); if (object_type_3_buffer[699] == 0)
	{
		f3(676, 168);
	}
	else {
	...
	} printMessage(0, 1230, 0); l12(0, 701, 0); *getObjectPointer(675) = -1; object_type_3_buffer[675] = ITEM_MIN_ID - 1; while (++object_type_3_buffer[675] <= ITEM_MAX_ID)
	{
		if (q8(t11(object_type_3_buffer[675]), -1) && object_type_3_buffer[675] != ITEM_ORB && isObjectFlagSet(t11(675), 3)) {
			printMessage(0, 1232, 0);
			set_object_location(object_type_3_buffer[675], object_type_3_buffer[676]); l12(0, 701, 1);
		}
...
int j36() {
	*getObjectPointer(675) = -1; 
	...
	{
		if (q8(t11(object_type_3_buffer[675]), 1027)) { 
	...
	*getObjectPointer(675) =
	...
	} l12(1, 699, 733); if (object_type_3_buffer[699] == object_type_3_buffer[734])
	{
		if (cheezy_rand(100) < 10) {
			l12(0, 701, 11); object_type_3_buffer[701] -= object_type_3_buffer[699]; object_type_3_buffer[700] = cheezy_rand(object_type_3_buffer[701]);
...
y20() {
	...
	else
	{
		...
		} t10(682, 85); set_object_location(85, object_type_3_buffer[671]);
	}
} int z24() {
	l12(1, 702, 670); if (object_type_3_buffer[697] == 1 || (513 <= object_type_3_buffer[669] && object_type_3_buffer[669] <= 522)) {
		l12(1, 702, 669);
	} if (object_type_3_buffer[701] == 0) { modifyObjectFlag('s', t11(671), 8); processMoveCommand(object_type_3_buffer[678], -1); }
	else {
	...
	object_type_3_buffer[756] -= 1; if (object_type_3_buffer[756] < 1 &&
		...
		x28(); if (object_type_3_buffer[701] == 1) { return 0; } l12(0, 755, -1); if (!(isObjectFlagSet(t11(755), 0)
			...
			if (!(isObjectFlagSet(t11(755), 9)
				|| cheezy_rand(100) < 75 || isObjectFlagSet(119, 4) || !(isObjectFlagSet(116, 4)))) {
				l12(0, 755, 9); modifyObjectFlag('s', t11(755), 9);
			}
		} if (object_type_3_buffer[755] == -1) {
			if (!(isObjectFlagSet(t11(755), 2) || cheezy_rand(100) < 75 || isObjectFlagSet(253, 4) ||
				!(isObjectFlagSet(250, 4)))) {
				l12(0, 755, 2); modifyObjectFlag('s', t11(755), 2);
			}
		} if (object_type_3_buffer[755] == -1) {
			if (!(isObjectFlagSet(t11(755), 3) || cheezy_rand(100) < 75 || !(isObjectFlagSet(259, 4)) || isObjectFlagSet(27, 13))) {
				l12(0, 755, 3);
				modifyObjectFlag('s', t11(755), 3);
			}
		} if (object_type_3_buffer[755] == -1) {
			if (!(isObjectFlagSet(t11(755), 4) || cheezy_rand(100) < 75
				|| isObjectFlagSet(253, 4))) {
				l12(0, 755, 4); modifyObjectFlag('s', t11(755), 4);
			}
		} if (object_type_3_buffer[755] == -1) {
			if (!(isObjectFlagSet(t11(755), 6) || cheezy_rand(100) < 75 || item_location[ITEM_STARSTONE] == LOCATION_MAGNIFICENT_VIEW || !(isObjectFlagSet(ITEM_STARSTONE, 4)))) {
				l12(0, 755, 6);
				modifyObjectFlag('s', t11(755), 6);
			}
		} if (object_type_3_buffer[755] == -1) {
			if (!(isObjectFlagSet(t11(755), 7) || cheezy_rand(100) < 75
				|| isObjectFlagSet(462, 4) || !(isObjectFlagSet(271, 4)))) {
				l12(0, 755, 7); modifyObjectFlag('s', t11(755), 7);
			}
		} if
			(object_type_3_buffer[755] == -1) {
			if (!(isObjectFlagSet(t11(755), 8) || cheezy_rand(100) < 75 || !(isObjectFlagSet(324, 4)))) {
				l12(0, 755, 8);
				modifyObjectFlag('s', t11(755), 8);
			}
		} if (object_type_3_buffer[755] == -1) {
			if (!(isObjectFlagSet(t11(755), 11) || cheezy_rand(100) < 75
				|| isObjectFlagSet(58, 4) || isObjectFlagSet(228, 8))) {
				l12(0, 755, 11); modifyObjectFlag('s', t11(755), 11);
			}
		} if (object_type_3_buffer[755] == -1)
		{
			if (!(isObjectFlagSet(t11(755), 10) || cheezy_rand(100) < 75 || !(isObjectFlagSet(35, 4)))) {
				l12(0, 755, 10);
				modifyObjectFlag('s', t11(755), 10);
			}
		} if (object_type_3_buffer[755] == -1) {
			if (!(isObjectFlagSet(t11(755), 12) || cheezy_rand(100) < 75
				|| !(isObjectFlagSet(415, 4)) || isObjectFlagSet(420, 4))) {
				l12(0, 755, 12); modifyObjectFlag('s', t11(755), 12);
			}
		}
		if (object_type_3_buffer[755] == -1) {
			if (!(isObjectFlagSet(t11(755), 5) || cheezy_rand(100) < 85)) {
				l12(0, 755, 5);
				modifyObjectFlag('s', t11(755), 5);
			}
		} object_type_3_buffer[756] = cheezy_rand(100 - 20 + 1) + 20; if (object_type_3_buffer[755] > -1) {
			f3(677, 1280);
...
int u23() {
	...
	{
		return 0;
	} l12(0, 700, 0); modifyObjectFlag('s', ITEM_STARSTONE, 15); *getObjectPointer(675) = -1; object_type_3_buffer[675] = ITEM_MIN_ID - 1; while
		(++object_type_3_buffer[675] <= ITEM_MAX_ID) {
		if (isObjectFlagSet(t11(675), 3)) {
	...
	} modifyObjectFlag('c', ITEM_STARSTONE, 15); if (object_type_3_buffer[700] > 0) {
		object_type_3_buffer[701] = cheezy_rand(object_type_3_buffer[700]); object_type_3_buffer[701] +=
			1; *getObjectPointer(674) = -1; object_type_3_buffer[674] = ITEM_MIN_ID - 1; while (++object_type_3_buffer[674] <= ITEM_MAX_ID) {
		...
		object_type_3_buffer[699] *= object_type_3_buffer[134]; if (cheezy_rand(100) < object_type_3_buffer[699]) {
			if (!(isObjectFlagSet(t11(675), 5))) {
				return
					0;
			} object_type_3_buffer[701] = cheezy_rand(object_type_3_buffer[760]); object_type_3_buffer[701] += 1; *getObjectPointer(674) = -1; object_type_3_buffer[674] = ITEM_MIN_ID - 1; while
				(++object_type_3_buffer[674] <= ITEM_MAX_ID) {
				if (object_type_3_buffer[701] > 0 && item_location[object_type_3_buffer[674]] == 435) {
					object_type_3_buffer[701] -= 1; if
						...
						if (isObjectFlagSet(t11(674), 5) || object_type_3_buffer[674] == object_type_3_buffer[686]) { return 0; } object_type_3_buffer[760]
							-= 1; set_object_location(object_type_3_buffer[674], object_type_3_buffer[676]);
					}
				}
			}
		} object_type_3_buffer[760] += 1; set_object_location(object_type_3_buffer[675], 435);
	}
} int a28()
{
...
int g32() {
	...
	} if (!(isObjectFlagSet(t11(675), 13) || isObjectFlagSet(t11(675), 14))) { return 0; } if (currentCommandContains(27))
	{
		return 0;
	} if (isObjectFlagSet(t11(675), 13)) { if (!(object_type_3_buffer[PLAYER_LOCATION] == 378)) { return 0; } }
	...
	} t10(673, 675); set_object_location(object_type_3_buffer[675], object_type_3_buffer[671]);
} int i42() {
...
int compute_score() {
	...
	*getObjectPointer(675) = -1; 
	...
	while (++object_type_3_buffer[675] <= ITEM_MAX_ID) {
		if (isObjectFlagSet(t11(675), 5)) { // if it's a treasure
			if (item_location[object_type_3_buffer[675]] == LOCATION_BUILDING || item_location[object_type_3_buffer[675]] == LOCATION_GRAY_NOWHERE)
			{
				...
				if (isObjectFlagSet(t11(675), 4)) { // seen ?
	...
	if (item_location[ITEM_MAGAZINE] != 236) {
		object_type_3_buffer[708] += 1;
	} 
...
int a29() {
	compute_score(); printMessage(13, 1033, 708); printMessage(13, 1035, 709);
...
int b28() {
	...
	if (g10(99, 1)) { 
		...
		if (object_type_3_buffer[PLAYER_LOCATION] == 256 && !(isObjectFlagSet(t11(697), 0))) { 
...
int e28() {
	...
	if (g10(ITEM_STARSTONE, -1) && object_type_3_buffer[705] < object_type_3_buffer[721]
		...
		if (object_type_3_buffer[ITEM_STARSTONE] == 0) {
			l12(0, ITEM_STARSTONE, 1); set_object_location(ITEM_STARSTONE, r5); printMessage(64, 1352, 0);
		} if (item_location[ITEM_STARSTONE] == object_type_3_buffer[671]) {
			if (isObjectFlagSet(ITEM_STARSTONE, 13)) { printMessage(64, 1354, 0); } modifyObjectFlag('s', ITEM_STARSTONE, 13);
	...
	if (isItemAtLocation(ITEM_STARSTONE, -1)) {
		...
		b26(); if (object_type_3_buffer[ITEM_STARSTONE] > 1 || object_type_3_buffer[PLAYER_LOCATION] == 324) {
			...
			else { printMessage(0, 1455, 0); } l12(0, ITEM_STARSTONE, 3); if (g10(85, -1)) { h23(); } if (object_type_3_buffer[699] == 1)
			{
				printBlankLine();
				y21();
			}
		...
		} if (object_type_3_buffer[PLAYER_LOCATION] == 393) { e24(); } if (object_type_3_buffer[PLAYER_LOCATION] == 204) {
			set_object_location(ITEM_STARSTONE, 203);
		} longjmp(done_with_command, 1);
	}
} int k23() {
	if (!isItemAtLocation(97, -1)) return 0; if (!g10(34, -1))
		return 0; set_object_location(97, PLAYER_LOCATION); printMessage(64, 1385, 0);
} int s27() {
	...
	} printMessage(12, 1492, 670); if (object_type_3_buffer[PLAYER_LOCATION] == 393) { e24(); } longjmp(done_with_command, 1);
} int g33() {
	...
	} if (object_type_3_buffer[PLAYER_LOCATION] == 393) { e24(); } longjmp(done_with_command, 1);
} int e29()
{
	...
	} if (object_type_3_buffer[PLAYER_LOCATION] == 393)
	{
		e24();
	} longjmp(done_with_command, 1);
} int h24() {
	...
	if (!isItemAtLocation(111, -1)) return 0; set_object_location(111, PLAYER_LOCATION); l12(0, 111, 2); if
		(object_type_3_buffer[PLAYER_LOCATION] == 393) {
...
int fill_with_oil() {
	if (q8(113, -1)) {
		...
		if (isItemAtLocation(111, 2)) { // Check if bottle is empty
			l12(0, 111, 4); 
			printMessage(76, 912, 113); // Your bottle is now full of oil.
		} 
		
		if (isItemAtLocation(114, 2)) { // Check if flask is empty
			l12(0, 114, 4);
			printMessage(76, 913, 113); // Your flask is now full of oil.
		} 
		
		if (isItemAtLocation(111, -1) && isItemAtLocation(114, -1)) { 
			printMessage(64, 1368, 0); // Both the flask and the bottle are already full.
		} 
		
		if (isItemAtLocation(111, -1))
		{
			printMessage(64, 910, 0); // Your bottle is already full.
		} 
		
		printMessage(64, 1369, 0); // The flask is already full.
	}
} 
...
int s28() {
	if (!(isObjectFlagSet(t11(671), 9)))
	{
		...
		if (object_type_3_buffer[PLAYER_LOCATION] == 412) {
			if (!(isItemAtLocation(111, -1) || isItemAtLocation(114, -1)))
			{
	...
	{
		l12(0, 20, 1); set_object_location(60, 247); set_object_location(117, 247); modifyObjectFlag('c', 20, 6); *getObjectPointer(675) = -1; object_type_3_buffer[675] = ITEM_MIN_ID - 1;
		while (++object_type_3_buffer[675] <= ITEM_MAX_ID) { if (q8(t11(object_type_3_buffer[675]), -1)) { set_object_location(object_type_3_buffer[675], 247); } } processMoveCommand(247, -1446);
	...
	if (y10(836)) {
		if (cheezy_rand(100) < 50) { printMessage(64, 1118, 0); } printMessage(0, 1119, 0);
		die();
	} printMessage(12, 1222, 669); printMessage(76, 1223, 670);
} int e30() {
	if (!g10(38, -1))
		return 0; if (isItemAtLocation(38, -1)) { printMessage(64, 1697, 0); } if (object_type_3_buffer[PLAYER_LOCATION] == 299 && object_type_3_buffer[38] < 2)
	{
		printMessage(64, 978, 0);
	} set_object_location(38, r5); printMessage(64, 1696, 0);
} int x29() {
	if (!g10(116, -1))
		return 0; if (object_type_3_buffer[116] == 0 && object_type_3_buffer[705] < object_type_3_buffer[721]) {
		if (object_type_3_buffer[119] == 2) {
			l12(0, 733, 5);
			object_type_3_buffer[116] += 1; set_object_location(116, r5); modifyObjectFlag('c', 434, 8); printMessage(64, 1089, 0);
	...
	{
		set_object_location(56, r5); l12(0, 56, 1); object_type_3_buffer[699] = cheezy_rand(4); if (object_type_3_buffer[699] == 0) {
			f3(683, 511);
		}
		else {
	...
	printBlankLine();
	object_type_3_buffer[677] = cheezy_rand(1199 - 1190 + 1) + 1190; printMessage(2, 677, 0);
} int j41() {
	printMessage(0, 936, 0); *getObjectPointer(675) = -1; object_type_3_buffer[675] = ITEM_MIN_ID - 1; while (++object_type_3_buffer[675] <= ITEM_MAX_ID)
	{
		...
		} if (isObjectFlagSet(t11(675), 3)) { if (isItemAtLocation(t11(object_type_3_buffer[675]), -1)) { set_object_location(object_type_3_buffer[675], PLAYER_LOCATION); } }
	...
	} modifyObjectFlag('s', 461, 4); modifyObjectFlag('s', LOCATION_GRAY_NOWHERE, 4); l12(0, 717, 3); l12(0, 143, 1);
	l12(0, 716, 999); l12(0, 672, 0); processMoveCommand(378, -2);
} int i45() {
	*getObjectPointer(675) = -1; object_type_3_buffer[675] = ITEM_MIN_ID - 1;
	...
	} if (!(item_location[ITEM_STARSTONE] == LOCATION_BUILDING || item_location[ITEM_STARSTONE] == LOCATION_MAGNIFICENT_VIEW || item_location[ITEM_STARSTONE] == LOCATION_LIMBO))
	{
		...
		return 0;
	} if (item_location[80] == LOCATION_BUILDING || item_location[80] == LOCATION_LIMBO) { l12(0, 717, 1); }
} int w26() {
	modifyObjectFlag('s', t11(697), 7);
	if (object_type_3_buffer[43] > 1) { return 0; } if (object_type_3_buffer[717] == 0) {
		...
		i45(); modifyObjectFlag('s', 64, 5); modifyObjectFlag('s', ITEM_STARSTONE, 5); if (object_type_3_buffer[717] == 1) { l12(0, 716, 35); }
		else
		{
			...
			object_type_3_buffer[116] = cheezy_rand(14) + 1;
			...
			if (isObjectFlagSet(t11(671), 7) || isObjectFlagSet(t11(671), 5)) {
				...
				b26(); if ((object_type_3_buffer[699] == 0 && object_type_3_buffer[713] > 150 && !(isObjectFlagSet(19, 4)) || isObjectFlagSet(19, 13)
					|| cheezy_rand(100) < 10) && !(isObjectFlagSet(49, 4)) && !g10(134, -1) && !(isObjectFlagSet(t11(671), 3)) && !(isObjectFlagSet(43, 12)))
				{
					...
					} if (isObjectFlagSet(67, 12)) { modifyObjectFlag('c', 67, 5); } t10(676, ITEM_STARSTONE); if (object_type_3_buffer[676] == object_type_3_buffer[671])
					{
						modifyObjectFlag('c', ITEM_STARSTONE, 5);
					} *getObjectPointer(675) = -1; object_type_3_buffer[675] = ITEM_MIN_ID - 1; while (++object_type_3_buffer[675] <= ITEM_MAX_ID) {
						if
							(g10(t11(object_type_3_buffer[675]), 1029)) {
							set_object_location(object_type_3_buffer[675], 192); l12(0, 700, 1);
						}
					...
					l12(1, 699, 715); object_type_3_buffer[699] += 2; object_type_3_buffer[699] *= 10; if
						((g10(134, -1) || cheezy_rand(100) < object_type_3_buffer[699]) && object_type_3_buffer[134] < object_type_3_buffer[715]) {
						if (isObjectFlagSet(115, 4)) {
							set_object_location(134, object_type_3_buffer[671]); object_type_3_buffer[134] += 1; if (object_type_3_buffer[134] == 1) {
							...
							if (!(isObjectFlagSet(t11(671), 11))) {
								b26(); if (object_type_3_buffer[699] == 0) {
									set_object_location(115, object_type_3_buffer[671]);
	...
	if (currentCommandContains(113))
	{
		...
		{
			if (currentCommandContains(112) && isObjectFlagSet(t11(671), 9)) { printMessage(64, 1588, 0); } if (g10(t11(object_type_3_buffer[670]), -1))
			{
			...
			if ((630 <= object_type_3_buffer[670] && object_type_3_buffer[670] <= 663)) {
				if (currentCommandContains(550)) { printMessage(0, 915, 0); }
				else
				{
				...
				object_type_3_buffer[699] = cheezy_rand(1009 - 1005 + 1) + 1005; printMessage(2, 699, 0);
			}
		}
	} longjmp(done_with_command, 1);
} int z25() {
	...
	if ((329 <= object_type_3_buffer[671] && object_type_3_buffer[671] <= 364) || object_type_3_buffer[PLAYER_LOCATION] == 328) {
...
int p36() {
	if (isObjectFlagSet(t11(671), 14) && !currentCommandContains(COMMAND_HELP) || !(isObjectFlagSet(t11(671), 8))) {
		return 0;
	} 
	l12(0, 677, 0); 
	...
	if (object_type_3_buffer[PLAYER_LOCATION] == 144 && object_type_3_buffer[4] == 0 && !isItemAtLocation(ITEM_KEYS, -1)) { 
		f3(677, 859); 
	} 
	...
	if (object_type_3_buffer[PLAYER_LOCATION] == 155 && g10(7, -1))
	{
		if (isObjectFlagSet(t11(735), 0)) {
			if (!(currentCommandContains(COMMAND_HELP) && !(isObjectFlagSet(t11(671), 14)))) {
				f3(677, 1579);
			}
		}
		else { 
	...
	if (object_type_3_buffer[PLAYER_LOCATION] == 236) {
		f3(677, 992);
	} 
	
	if ((object_type_3_buffer[PLAYER_LOCATION] == 228 || object_type_3_buffer[PLAYER_LOCATION] == 227 || object_type_3_buffer[PLAYER_LOCATION] == 229) && !(isObjectFlagSet(229, 4))) {
		f3(677, 990);
	} 
	...
	if (y10(object_type_3_buffer[677])) {
		...
		if (y10(986)) {
			...
			} if (object_type_3_buffer[PLAYER_LOCATION] == 228 || object_type_3_buffer[PLAYER_LOCATION] == 227
			...
			} if (object_type_3_buffer[PLAYER_LOCATION] == 236) { modifyObjectFlag('s', t11(735), 2); } if ((328 <= object_type_3_buffer[671]
				&& object_type_3_buffer[671] <= 364) || object_type_3_buffer[PLAYER_LOCATION] == 328) {
